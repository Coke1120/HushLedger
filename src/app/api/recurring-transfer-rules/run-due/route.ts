...
import { hktCalendarDate } from '../../../../server/recurring'
import { runDueRecurringTransferRules } from '../../../../server/recurringTransfers'
...
export const POST = apiRoute(async (request) => {
  ...
  return jsonSuccess(await runDueRecurringTransferRules(await getDatabase(), asOf))
})
