import {
  ...
  PRE_MULTI_CURRENCY_LEDGER_SCHEMA_VERSION,
...
function backupCompatibilityError(value: unknown) {
  ...
  if (
    ...
    (
      ...
      candidate.schemaVersion !== PRE_ECB_REFERENCE_RATES_LEDGER_SCHEMA_VERSION &&
      candidate.schemaVersion !== PRE_MULTI_CURRENCY_LEDGER_SCHEMA_VERSION &&
      candidate.schemaVersion !== PRE_IMPORT_REVIEW_LEDGER_SCHEMA_VERSION &&
