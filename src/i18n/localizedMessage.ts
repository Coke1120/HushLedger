...
const apiErrorMessageKeys: Readonly<Record<string, MessageKey>> = {
  ...
  REFERENCE_EMERGENCY_FUND_GOAL: 'errorReferenceEmergencyFundGoal',
  EMERGENCY_FUND_ACCOUNT_INVALID: 'errorEmergencyFundAccountInvalid',
  EMERGENCY_FUND_GOAL_NOT_FOUND: 'errorEmergencyFundGoalNotFound',
  EMERGENCY_FUND_GOAL_VERSION_CONFLICT: 'errorEmergencyFundGoalVersionConflict',
  LEDGER_CURRENCY_UNSUPPORTED: 'errorLedgerCurrencyUnsupported',
  LEDGER_CURRENCY_VERSION_CONFLICT: 'errorLedgerCurrencyVersionConflict',
  LEDGER_CURRENCY_LOCKED: 'errorLedgerCurrencyLocked',
  ...
  CSV_IMPORT_STALE: 'csvImportPreviewRequired',
